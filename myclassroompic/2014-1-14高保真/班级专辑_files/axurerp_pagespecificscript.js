...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('查看照片评论.html');
...
if (true) {
	...
	self.location.href=$axure.globalVariableProvider.getLinkUrl('班级相册.html');
...
gv_vAlignTable['u7'] = 'top';gv_vAlignTable['u9'] = 'center';